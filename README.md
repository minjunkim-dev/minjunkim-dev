...
|---|---|---|
| **MyD · 마이디** | Swift/iOS 중심 · 데이터 거래·인증·스크래핑·네이티브 통합 · 현재 운영 | [App Store](https://apps.apple.com/kr/app/id1576612543) · [Google Play](https://play.google.com/store/apps/details?id=io.snplab.myd) |
| **TBN교통방송** | React Native/TypeScript · iOS/Android 출시 · 방송·오디오·지역·FCM·GA4 · 현재 운영 | [App Store](https://apps.apple.com/kr/app/id969867489) · [Google Play](https://play.google.com/store/apps/details?id=com.mtelo.tbn) |
...
- **Mobile identity:** DID/VC, App Attest, secp256k1, Groth16, biometric and screen security
